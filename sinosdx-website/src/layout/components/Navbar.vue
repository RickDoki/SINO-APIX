  ...
  <div class="navbar_top">
    ...
    <div class="breadcrumb">
      <el-breadcrumb
        ...
        separator="/"
      >
        <el-breadcrumb-item v-if="routerList[0].path === '/dashboard' ? false : true" :to="{ path: '/dashboard/index' }"
      ...
      <!-- <div
        v-show="routerList[1].meta.title == 'API发布' ? false : true"
        class="dashboard"
      >
        {{ routerList[1].meta.title }}
      </div> -->
    </div>
  </div>
</template>
