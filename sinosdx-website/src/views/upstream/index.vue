        ...
        <div style="text-align: right">
          <div class="but-right2">
            ...
            <el-button
              size="small"
              type="primary"
              style="background-color: #2c66fb; margin-left: 10px"
              >复制</el-button
            >
    ...
    >
      <div class="demo-drawer__content">
        <el-descriptions title=" " size="medium" :column="2" border>
          ...
          <el-descriptions-item label="负载均衡算法">{{
            upstreamInfo.load_balance
          }}</el-descriptions-item>
          <el-descriptions-item label="服务端口">{{
            upstreamInfo.port
          }}</el-descriptions-item>
          <el-descriptions-item label="路由前置路径">{{
            upstreamInfo.prefix_path
          }}</el-descriptions-item>
          <el-descriptions-item label="协议">{{
            upstreamInfo.protocol
          }}</el-descriptions-item>
          <el-descriptions-item label="服务地址">{{
            upstreamInfo.server_address
          }}</el-descriptions-item>
          <el-descriptions-item label="服务描述">{{
            upstreamInfo.description
          }}</el-descriptions-item>
        </el-descriptions>
      </div>
    </el-drawer>
      ...
      if (buttonList[index].name === name) {
        ...
        for (let index1 = 0; index1 < buttonList[index].list.length; index1++) {
          ...
          if (buttonList[index].list[index1].name === "删除") {
           ...
           if (buttonList[index].list[index1].name === "查看") {
            this.ischakanShow = true;
          }
