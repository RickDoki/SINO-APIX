  ...
  <div class="main">
    <el-card class="box-card" shadow="never">
      <div class="card-top">
        ...
        <div class="but-right">
          <el-button size="small"  @click="regetRoleList('?limit=10&offset=1')">重置</el-button>
          <el-button size="small" style="background-color: #2C66FB;" type="primary" @click="getRoleList('?limit=10&offset=1')">查询</el-button>
        </div>
      </div>
      <el-table :row-style="{height:'48px'}" :data="tableData" stripe :header-cell-style="{background:'#F0F2F5',color:'#333333'}">
        ...
        <el-table-column label="操作">
          <template slot-scope="scope">
            <el-button v-if="ispeizhiShow" type="text" @click="edit(scope.row)" style="color: #2C66FB;">配置</el-button>
