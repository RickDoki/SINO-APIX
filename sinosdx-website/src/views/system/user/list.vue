    ...
    <el-card class="box-card" shadow="never">
      ...
      <el-table :row-style="{height: '48px'}" :data="tableData" stripe :header-cell-style="{background:'#F0F2F5',color:'#333333'}">
        ...
        <el-table-column label="操作">
          <template slot-scope="scope">
            <el-button v-if="isbuttonShow" type="text" @click="edit(scope.row)" style="color: #2C66FB;">配置</el-button>
      ...
      <div class="demo-drawer__content">
        ...
        <el-form :model="form" ref="form" :rules="rules" label-position="top">
          <el-form-item label="用户名" prop="username">
            <el-input maxlength="25" show-word-limit v-model="form.username" autocomplete="off" placeholder="请输入用户名"></el-input>
          </el-form-item>
