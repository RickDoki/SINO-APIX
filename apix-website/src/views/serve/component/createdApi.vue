    ...
    <div class="main" style="margin-left: 30px; width: 95%">
        ...
        <div v-if="active === 0" class="formBox">
          ...
          >
            ...
            <el-form-item label="协议" prop="protocol">
              ...
              <span @click="changeShow" class="show-but"
                >展示剩余四项配置
                <i class="el-icon-arrow-down" v-if="!showTimeFlag"></i
      ...
      <div class="bottom">
        <div class="bottom_button">
          <el-button size="small" v-if="active === 0" @click="backList"
            >取消</el-button
          >
          <el-button
            size="small"
        ...
        <div class="bottom_button_b">
          <el-button size="small" v-if="active === 1" @click="goBACK"
            >上一步</el-button
          >
          <el-button
            size="small"
