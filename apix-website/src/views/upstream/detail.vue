      ...
      <div class="formBox">
        <el-form ref="form" :model="form" :rules="rules" label-width="130px" label-position="left" size="small">
          ...
          <el-form-item>
            ...
            <el-input v-model="tautologyNum" class="selectWidth" readonly>
          ...
          <el-form-item>
            ...
            <el-input v-model="connectNum" class="selectWidth" readonly>
          ...
          <el-form-item>
            ...
            <el-input v-model="sendNum" class="selectWidth" readonly>
              <template slot="append">s</template>
            </el-input>
          </el-form-item>
          <el-form-item>
            ...
            <el-input v-model="receiveNum" class="selectWidth" readonly>
              <template slot="append">s</template>
            </el-input>
          </el-form-item>
          <!-- 健康检查 -->
