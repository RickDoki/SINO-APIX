...
public interface IGatewayLogService extends SuperService<GatewayLog> {
     ...
     * @return
     */
    R<Object> queryGatewayLogList(String httpMethod, String domain, String requestPath, Long startTime, Long endTime,String appCode,Integer limit, Integer offset);
