...
public enum ResultCodeEnum implements BaseEnum {
    ...
    LESSEE_APP_IS_NOT_EXIST(826024, "当前应用未发布，不允许订阅"),
    LESSOR_APP_IS_NOT_EXIST(826025, "申请订阅的应用不存在"),
    APP_LEASE_IS_EXIST(826026, "已订阅过该应用，请勿重复订阅"),
    APP_LEASE_IS_NOT_EXIST(826027, "当前订阅不存在，请检查数据"),
    ...
    NONE_APP_VERSION(826032, "该应用无可订阅版本"),
    ...
    APP_PLUGIN_NOT_EXIST(826015, "已添加过此插件"),
